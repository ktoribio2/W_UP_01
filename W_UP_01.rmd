...
In this study, we are trying to figure out if there is a difference in the amount of pushups that line players can do vs the amount of pushups that skill players can do. We gathered this data from the  Georgetown College football team. Is there a statisitcal difference in teh average number of pushups between both positions?
